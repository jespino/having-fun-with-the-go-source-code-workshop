...
2. **Install Go**: Follow the official installation guide for your platform:
...
Let's clone the official Go repository. We use `--depth 1` to avoid downloading the full history, making the clone much faster:
...
## Step 3: Verify Go Version 1.26.1
